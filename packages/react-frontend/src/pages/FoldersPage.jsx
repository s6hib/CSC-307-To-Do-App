...
export default function FoldersPage() {
  ...
  async function deleteFolder(id, e) {
    ...
    if (!window.confirm("Delete this folder and all its tasks?")) return;
  ...
  return (
    <div className="container" style={{ padding: 16 }}>
      ...
      <div style={{ marginBottom: "30px" }}>
        <h1 style={{ fontSize: "32px", fontWeight: "300", margin: "0 0 5px 0" }}>
          adder
        </h1>
      ...
      <h2 style={{ fontSize: "24px", marginBottom: "20px" }}>to-do folders</h2>
      ...
      <div style={{
        ...
        {!showNewFolderForm && (
          ...
          >
            ...
            <div style={{ fontSize: "14px", color: "#666" }}>new folder</div>
          </div>
        )}
      </div>
      ...
      {showNewFolderForm && (
        <div style={{
          ...
          <h3 style={{ marginTop: 0, fontSize: "18px" }}>create new folder</h3>
          <input
            type="text"
